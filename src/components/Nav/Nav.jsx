      ...
      <div className="container">
        <nav className='navbar navbar-expand-lg py-3'>
          <div className="container-fluid">
            ...
            <div className="collaspe navbar-collapse justify-content-center" id='navbarNav' aria-expanded="false" aria-label='Toggle navigation'>
              <ul className="navbar-nav gap-3 nav-menu">
                <li className="nav-item">
                  <a href="#" className='nav-link text-white fw-semibold fs-6 custom-link'>Home</a>
                </li>
                <li className="nav-item">
                  <a href="#" className='nav-link text-white fw-semibold fs-6 custom-link'>About Me</a>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                  <a href="#" className='nav-link text-white fw-semibold fs-6 custom-link'>Pricing</a>
                </li>
                <li className="nav-item">
